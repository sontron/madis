...
if(is.na(hTestParams$xvars)){
  ...
  for(i in 1:nrow(hTestParams)){
    ...
    cat('\n')
    #print(pander(resDesc[[i]]$resTabDesc))
    hTest(data=LstMedstats$Data[[hTestParams$dataName[i]]],xvars=hTestParams$xvars[i],yvars=hTestParams$yvars[i],alter=hTestParams$alter[i],paired=hTestParams$paired[i],confLevel=hTestParams$confLevel[i],nullHyp=hTestParams$nullHyp[i])->res
