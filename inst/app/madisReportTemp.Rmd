...
if(!all(is.na(myTableParms$data))){
  ...
  cat('\n')
    ...
    cat('\n')
    cat(pander::pander(table1(data=LstMadis$Data[[myTableParms$data[i]]],grpVars=myTableParms$grpVars[i],testVars=myTableParms$testVars[i],Digits=myTableParms$Digits[i]),split.table=Inf))
    cat('\n')
    cat('\n')
